    ...
    return (
        <AppBar position="sticky">
            <Toolbar>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, cursor: 'pointer' }} onClick={() => navigate('/ownerhome')}>
                ...
                <IconButton title="Settings" onClick={() => navigate('/owner/settings')} sx={{ color: 'text.secondary', mr: 1 }}>
